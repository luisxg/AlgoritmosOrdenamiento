...
public class InsertionSort extends javax.swing.JFrame {
    ...
    public InsertionSort(int[] arreglo, int dimension) {
        initComponents();
        setLocationRelativeTo(null);
        setIconImage(new ImageIcon(getClass().getResource("/Imagenes/icono.png")).getImage());
        setTitle("Insertion Sort");
    ...
    public void ordenarInsertionSort(int[] arregloOrdenado) {

        int n = arregloOrdenado.length;
        long startTime = System.nanoTime();

        for (int i = 1; i < n; ++i) {
            int key = arregloOrdenado[i];
            int j = i - 1;
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ordenarInsertionSort(arregloOrdenado);
