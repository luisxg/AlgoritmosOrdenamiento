...
public class BubbleSort extends javax.swing.JFrame {
    ...
    public BubbleSort(int[] arreglo, int dimension) {
        initComponents();
        setLocationRelativeTo(null);
        setIconImage(new ImageIcon(getClass().getResource("/Imagenes/icono.png")).getImage());
        setTitle("Bubble Sort");
    ...
    public void ordenarBubbleSort(int[] arregloOrdenado) {
        ...
        for (int i = 0; i < n; i++) {
            for (int j = 1; j < (n - i); j++) {
                if (arregloOrdenado[j - 1] > arregloOrdenado[j]) {
                    temp = arregloOrdenado[j - 1];
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ordenarBubbleSort(arregloOrdenado);
